        ...
        do
        {
            ...
            switch (obj)
            {
                ...
                case FinÉtage.String:
                    ...
                    break;
                case Point.String:
                    ListGameObject.Last().AddComponent<Point>().Initialisation(Maths.GestionAngle(attributs[0]), attributs[1] * DELTA_HAUTEUR, attributs[2] == 0 ? false : true, attributs[3], Materials.Get((int)NomMaterial.Point));
                    break;
            }
